...
tasks = [
  ...
  {"Name": "Esperando data de abertura do NaturWaterPark 29/05/26", "Status": "Em Andamento", "description": "Ainda temos de esperar para o paque aquático abrir, primeiro!", "complete": False, "rejected": False},
  {"Name": "Esperando data para perguntar", "Status": "Em Andamento", "description": "Esperando pela hora de perguntar em breve!", "complete": False, "rejected": False},
  {"Name": "Aprovado por pai do Bruno", "Status": "Em Andamento", "description": "Esperando pela hora de perguntar em breve!", "complete": False, "rejected": False},
  {"Name": "Aprovação do pais do Bruno", "Status": "-", "description": "Esperando pela aprovação dos pais do Bruno ainda! :)", "complete": False, "rejected": False},
  ...
  {"Name": "Dia confirmado. Dia: (em breve vai aparecer aqui)", "Status": "-", "description": "Ainda esperamos pela confirmação do dia oficial à visita!", "complete": False, "rejected": False},
  {"Name": "Verificação do clima para o dia comfirmado", "Status": "-", "description": "Ainda temos de verificar como vai estar o nosso dia", "complete": False, "rejected": False},
  {"Name": "Arrumar a mochila para a viagem!", "Status": "-", "description": "Temos de esperar a anterior estar completa ;(", "complete": False, "rejected": False},
...
def getTasks():
  ...
  # check for auto update tasks
  if datetime.datetime.now().day == 29 and datetime.datetime.now().month == 5 or datetime.datetime.now().month > 5:
    for task in tasks:
      if task["Name"] == "Esperando data de abertura do NaturWaterPark 29/05/26":
        task["complete"] = True

...
tasks = [
  ...
  {"Name": "Permissão de Deixar o Dinis vir.", "Status": "Completa", "description": "Os pais do Bruno ainda têm de permitir o Dinis vir na viagem!", "complete": True, "rejected": False},
  {"Name": "Dia confirmado", "Status": "Em Andamento", "description": "Ainda esperamos pela confirmação do dia oficial à visita!", "complete": False, "rejected": True},
